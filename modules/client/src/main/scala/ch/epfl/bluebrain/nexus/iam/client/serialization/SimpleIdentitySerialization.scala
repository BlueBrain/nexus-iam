package ch.epfl.bluebrain.nexus.iam.client.serialization

import ch.epfl.bluebrain.nexus.commons.types.identity.Identity
import ch.epfl.bluebrain.nexus.iam.client.serialization.SimpleIdentitySerialization.SimpleIdentity._
